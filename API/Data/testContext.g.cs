...
namespace test.Data
{
    public class testContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-HN6RHOU\\SQLEXPRESS;Initial Catalog=T388042_test;Persist Security Info=True;user id=sa;password=admin;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
